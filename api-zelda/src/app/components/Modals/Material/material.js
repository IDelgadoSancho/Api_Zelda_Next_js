                ...
                <div className="p-6 text-[#CE9C39]">
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="md:w-2/3">
                            ...
                            <div className="mb-4">
                                <h3 className="text-lg font-semibold text-[#CE9C39]">Efecto al cocinar</h3>
                                <p className="text-[#b8a070]">{cooking_effect || "Sin efectos especiales"}</p>
                            </div>

                            <div className="mb-4">
                                <h3 className="text-lg font-semibold text-[#CE9C39]">Recuperación de corazones</h3>
                                <div className="flex items-center">
                                    <p className="text-[#b8a070] mr-2">{hearts_recovered}</p>
                                    {hearts_recovered > 0 && (
                                        <div className="flex">
