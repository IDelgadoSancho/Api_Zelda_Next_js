    ...
    return (
        <div className="max-w-2xl mx-auto p-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    <label htmlFor="hearts" className="block text-sm font-medium">Corazones que recupera</label>
                    <input
                        type="number"
                        id="hearts"
                        name="hearts"
                ...
                <div>
                    <label htmlFor="cooking_effect" className="block text-sm font-medium">Efectos al cocinar</label>
                    <input
                        type="text"
                        id="cooking_effect"
                        name="cooking_effect"
